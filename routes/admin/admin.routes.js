...
const { getAllUsers, getUserById, updateUser, deleteUser, createUserByAdmin } = require("../../controller/user.controller");
...
//course-requests
router.post('/course-requests', courseRequestController.createCourseRequest);
