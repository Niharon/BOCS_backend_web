...
import { getAllInstructorsApi } from '../../api/instructorsApi'
                                    ...
                                    (
                                        <tr key={instructor?.id}>
                                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark xl:pl-5">
                                                <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                                                    <div className="h-12.5 w-15 rounded-md">
                                                        <img src={instructor.photo ? import.meta.env.VITE_BACKEND_URL + instructor.photo : "https://via.placeholder.com/200x200"} alt="Product" />
                                                    </div>
                                            ...
                                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                <p className="text-black dark:text-white">{instructor.designation}</p>
                                            </td>

                                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                <div className="flex items-center space-x-3.5">

                                                    <Link to={`/instructors/edit/${instructor?.id}`} className="hover:text-primary">
                                                        <FaEdit />
                                                    </Link>
                                                    <button onClick={() => deleteCourse(instructor?.id)} className="hover:text-primary">
                                                        <svg
