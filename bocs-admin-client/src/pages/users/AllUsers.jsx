...
const columns = [
    ...
    {
        field: 'device_changable',
        headerName: 'Device Changable',
        flex: .9,
        minWidth: 130,
        renderCell: ({ row: { device_changable } }) => (
            <>
                {device_changable ?
                    <span className='rounded-full bg-success p-2'>
                        <FaCheck fontSize="16px" color='white' />
                    </span>

                    :
                    <span className='rounded-full bg-danger p-2'>
                        <FaTimes fontSize="16px" color='white' />
                    </span>
    ...
    },
    {
        ...
        field: 'Action',
        renderCell: (params) => <UserTableActions userId={params.id} />
    },
];
